...
describe("Subscription Validation", () => {
  describe("validateSubscriptionTerritoryPricing", () => {
    ...
    it("should pass validation when subscription is missing prices for available territories (prices can now be deduced)", () => {
      const subscription = {
        productId: "test_product",
        availability: {
    ...
    it("should handle missing prices gracefully (prices can now be deduced)", () => {
      const subscription = {
        productId: "test_product",
        availability: {
          availableTerritories: ["USA"],
