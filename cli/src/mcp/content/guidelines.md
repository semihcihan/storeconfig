...
1. **Authenticate** - Configure local Apple credentials (one-time setup)

_Note: Assume Apple credentials have already been configured. If not, self-explanatory CLI errors will indicate what to do._
