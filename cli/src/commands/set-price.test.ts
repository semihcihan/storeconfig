...
describe("set-price command", () => {
  ...
  beforeEach(() => {
    ...
    mockStoreConfigEngine.applyPricingChanges.mockResolvedValue({} as never);
    mockStoreConfigEngine.fetchTerritoryPricePointsForSelectedItem.mockResolvedValue(
      [] as never
    );
  ...
  afterEach(() => {
    ...
    mockStoreConfigEngine.applyPricingChanges.mockClear();
    mockStoreConfigEngine.fetchTerritoryPricePointsForSelectedItem.mockClear();
  ...
  describe("command execution", () => {
    it("should execute successfully with valid input", async () => {
      ...
      expect(mockStoreConfigEngine.applyPricingChanges).toHaveBeenCalled();
  ...
  describe("shortcut handling", () => {
    it("should remove shortcuts at start and apply them back at end", async () => {
      ...
      mockStoreConfigEngine.applyPricingChanges.mockResolvedValueOnce(
