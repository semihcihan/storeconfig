...
export async function createAppInfoLocalization(
  ...
  if (!response.data) {
    throw new ContextualError(`Failed to create app info localization`, {
...
export async function getAppInfoLocalization(
  ...
  if (!response.data) {
    throw new ContextualError(`Failed to get app info localization`, {
      appleError: response.error,
    });
  }
...
export async function updateAppInfoLocalization(
  ...
  if (!response.data) {
    throw new ContextualError(`Failed to update app info localization`, {
      appleError: response.error,
    });
  }
...
export async function deleteAppInfoLocalization(
  ...
  if (response.error) {
    throw new ContextualError(`Failed to delete app info localization`, {
      appleError: response.error,
    });
  }
}
...
export async function getAppInfoLocalizationsForAppInfo(
  ...
  if (!response.data) {
    throw new ContextualError(`Failed to get app info localizations`, {
      appleError: response.error,
    });
  }
...
export async function getAppInfosForApp(
  ...
  if (!response.data) {
    throw new ContextualError(`Failed to get app infos`, {
      appleError: response.error,
    });
  }
