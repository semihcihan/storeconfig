...
export async function createAppStoreVersion(
  ...
  if (!response.data) {
    throw new ContextualError("Failed to create app store version", {
...
export async function getAppStoreVersion(
  ...
  if (!response.data) {
    throw new ContextualError("Failed to get app store version", {
      appleError: response.error,
    });
  }
...
export async function updateAppStoreVersion(
  ...
  if (!response.data) {
    throw new ContextualError("Failed to update app store version", {
      appleError: response.error,
    });
  }
...
export async function deleteAppStoreVersion(versionId: string): Promise<void> {
  ...
  if (response.error) {
    throw new ContextualError("Failed to delete app store version", {
      appleError: response.error,
    });
  }
}
...
export async function getAppStoreVersionsForApp(
  ...
  if (!response.data) {
    throw new ContextualError("Failed to get app store versions", {
      appleError: response.error,
    });
  }
...
export async function getAppStoreVersionLocalization(
  ...
  if (!response.data) {
    throw new ContextualError("Failed to get app store version localization", {
      appleError: response.error,
    });
  }
...
export async function getAppStoreVersionLocalizationsForVersion(
  ...
  if (!response.data) {
    throw new ContextualError("Failed to get app store version localizations", {
      appleError: response.error,
    });
  }
