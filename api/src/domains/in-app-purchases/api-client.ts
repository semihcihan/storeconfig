...
export async function fetchInAppPurchaseLocalizations(
  iapId: string
  ...
  if (response.error) {
    throw new ContextualError("Failed to fetch in-app purchase localizations", {
...
export async function fetchInAppPurchases(
  ...
  if (response.error) {
    ...
    if (is404Error) {
      ...
      throw new ContextualError("Failed to fetch in-app purchases", {
        appleError: response.error,
      });
    }
  }
...
export async function fetchInAppPurchaseAvailability(
  ...
  components["schemas"]["InAppPurchaseAvailabilityResponse"] | undefined
> {
  const response = await api.GET(
  ...
  if (response.error) {
    ...
    throw new ContextualError("Failed to fetch in-app purchase availability", {
      appleError: response.error,
    });
  }
...
export async function fetchInAppPurchaseAvailabilityTerritories(
  ...
  if (response.error && !isNotFoundError(response.error)) {
    throw new ContextualError(
      "Failed to fetch in-app purchase availability territories",
      {
        appleError: response.error,
      }
    );
...
export async function fetchBaseTerritory(
  ...
  if (response.error) {
    throw new ContextualError("Failed to fetch base territory", {
      appleError: response.error,
    });
  }
...
export async function fetchManualPrices(
  ...
  if (response.error) {
    throw new ContextualError("Failed to fetch manual prices", {
      appleError: response.error,
    });
  }
...
export async function fetchAutomaticPrices(
  ...
  if (response.error) {
    throw new ContextualError("Failed to fetch automatic prices", {
      appleError: response.error,
    });
  }
...
export async function createInAppPurchase(
  ...
  if (response.error) {
    throw new ContextualError("Failed to create in-app purchase", {
      appleError: response.error,
    });
  }
...
export async function updateInAppPurchase(
  ...
  if (response.error) {
    throw new ContextualError("Failed to update in-app purchase", {
      appleError: response.error,
    });
  }
...
export async function createInAppPurchaseLocalization(
  ...
  if (response.error) {
    throw new ContextualError("Failed to create in-app purchase localization", {
      appleError: response.error,
    });
  }
...
export async function updateInAppPurchaseLocalization(
  ...
  if (response.error) {
    throw new ContextualError("Failed to update in-app purchase localization", {
      appleError: response.error,
    });
  }
...
export async function deleteInAppPurchaseLocalization(
  ...
  if (response.error) {
    throw new ContextualError("Failed to delete in-app purchase localization", {
      appleError: response.error,
    });
  }
}
...
export async function getIAPAvailability(
  ...
  if (response.error) {
    ...
    throw new ContextualError("Failed to get IAP availability", {
      appleError: response.error,
    });
  }
...
export async function createIAPAvailability(
  ...
  if (response.error) {
    throw new ContextualError("Failed to create IAP availability", {
      appleError: response.error,
    });
  }
...
export async function getIAPPriceScheduleId(
  ...
  if (response.error) {
    ...
    throw new ContextualError("Failed to get IAP price schedule ID", {
      appleError: response.error,
    });
  }
...
export async function findIAPPricePointId(
  ...
  return await findPricePointId(price, territory, iapId, "iap");
}
...
export async function createIAPPriceSchedule(
  ...
  if (response.error) {
    throw new ContextualError("Failed to create IAP price schedule", {
      appleError: response.error,
    });
  }
...
export async function deleteInAppPurchase(iapId: string): Promise<void> {
  ...
  if (response.error) {
    throw new ContextualError("Failed to delete in-app purchase", {
      appleError: response.error,
    });
  }
}

export async function fetchIAPPricePointEqualizations(
  pricePointId: string
): Promise<InAppPurchasePricePointsResponse> {
  const response = await api.GET(
